...
'''Arguments positionnels et obligatoires pour generer une playlist'''
...
parser.add_argument("--g", action = 'append', help = "Le genre de musique voulue '", nargs = 2)

#--ar permettre de specifie un artiste voulue
parser.add_argument("--ar", action = 'append', help = "L'artiste voulu ", nargs = 2)

#--alb permettera de specifie un album voulue
parser.add_argument("--alb",action = 'append', help="L'album voulue", nargs = 2)

#--t permettera de specifie un titre voulue
parser.add_argument("--t", action = 'append', help = "Le titre voulue", nargs = 2)

#--sg permettera de specifie un sous genre
parser.add_argument("--sg", action = 'append', help = "Le sous genre voulue", nargs = 2)
